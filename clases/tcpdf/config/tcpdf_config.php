 ...
 */
define ('PDF_HEADER_LOGO', 'logoupes.png');
 ...
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Universidad Politecnica de El Salvador');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "Sistema Automatizado de Horas Sociales - \nwww.upes.edu.sv");
